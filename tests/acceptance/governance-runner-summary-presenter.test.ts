...
describe('governance runner summary presenter', () => {
  it('separates structured metadata lines from raw event lines and exposes a combined CLI presentation', () => {
        ...
        reviewerRouteExplainability: [
          {
            ...
            rolloutGate: {
              ...
              blockingProofs: [],
              cleanupAllowed: true,
              canClaimFullIsomorphism: true,
              summary: 'Reviewer rollout ready for cursor, claude, and codex routes.',
            },
            hosts: {
              cursor: {
    ...
    expect(presentation.structuredMetadataLines).toEqual([
      ...
      '- Reviewer Complexity: Triple-host carrier parity is wired through reviewer shared-core routing for Cursor, Claude, and Codex.',
      '- Reviewer Blocker: none',
      '- Reviewer Rollout Gate: ready -> Reviewer rollout ready for cursor, claude, and codex routes.',
