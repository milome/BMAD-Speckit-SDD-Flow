...
const VALIDATOR_PATH = path.join(
  ...
  'tools',
  'script-migration',
  'validate-main-agent-runtime-migration-wave-3-6.cjs'
);
...
describe('main-agent runtime migration wave 3.6 contract', () => {
  it('creates required Wave 3.6 governance artifacts', () => {
  ...
  it('runs the Wave 3.6 migration validator successfully', () => {
