...
const VALIDATOR_PATH = path.join(
  ...
  'tools',
  'script-migration',
  'validate-main-agent-runtime-migration-wave-3-9.cjs'
);
...
describe('main-agent runtime migration wave 3.9 contract', () => {
  it('creates required Wave 3.9 governance artifacts', () => {
  ...
  it('runs the Wave 3.9 migration validator successfully', () => {
