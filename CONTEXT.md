...
A `/goal` entry document projected from the compiled execution packet for long-running host execution.
_Avoid_: machine-readable authority, closeout proof, independent requirement source
