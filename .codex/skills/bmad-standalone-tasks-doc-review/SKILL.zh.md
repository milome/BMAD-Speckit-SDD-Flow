...
- **audit-prompts §4**：`.codex/skills/speckit-workflow/references/audit-prompts.md` §4（主流程 TASKS 文档审计）
- **audit-prompts §5**：`.codex/skills/speckit-workflow/references/audit-prompts.md` §5（模式 B 实施后审计）
...
- **audit-post-impl-rules**：`.codex/skills/speckit-workflow/references/audit-post-impl-rules.md`（模式 B 收敛规则）
...
- 收敛规则见 `.codex/skills/speckit-workflow/references/audit-post-impl-rules.md`
