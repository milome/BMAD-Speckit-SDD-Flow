...
```text
HOST_MISMATCH: Loaded the Claude variant of bmad-standalone-tasks-doc-review under a Cursor host. Use ``.codex`/skills/bmad-standalone-tasks-doc-review/SKILL.md` instead.
```

3. **Do not** continue into this Codex adapter鈥檚 fallback logic
