...
const reportPath =
  '_bmad-output/runtime/requirement-records/REQ-CLOSED-LOOP-DESIGN/evidence/TRACE-016/trace-016-entryflow-traceability-001/entry-flow-adaptation-matrix.json';

const commands = [
  {
    commandId: 'CMD-TRACE-016-ENTRYFLOW-TRACEABILITY-CHECK',
    command:
      ...
      reportPath +
      ' --evaluated-at 2026-05-19T22:14:00.000+08:00 --evaluated-by codex --json',
  },
  {
    commandId: 'CMD-TRACE-016-ENTRYFLOW-TRACEABILITY-TEST',
    command:
