...
const resumeOutDir =
  '_bmad-output/runtime/requirement-records/REQ-CLOSED-LOOP-DESIGN/evidence/TRACE-015/trace-015-functional-resume-registry-001/resume';

const commands = [
  {
    commandId: 'CMD-TRACE-015-FUNCTIONAL-RESUME-REGISTRY-CHECK',
    command:
      'npx ts-node --project tsconfig.node.json --transpile-only scripts/main-agent-functional-resume-check.ts --requirement-record _bmad-output/runtime/requirement-records/REQ-CLOSED-LOOP-DESIGN/requirement-record.json --source docs/design/需求实现完整性门禁与重跑闭环设计.md --out-dir ' +
      resumeOutDir +
      ' --checkpoint-id checkpoint-trace-015-001 --expected-source-document-hash sha256:426b56bec964e275600935e5dee293985c61483e34f523b66f3b705247ad2294 --expected-implementation-confirmation-hash sha256:e5e8b680fa4e1d273c29bea5a613ef595486868e8e57dae0fa48ac47016909ec --expected-architecture-confirmation-hash sha256:fe98c301cf8479be934a8258ad584575e146e2d5cc2e846bf6ccec1a1e6909f1 --generated-at 2026-05-19T22:05:00.000+08:00 --generated-by codex --json',
  },
  {
    commandId: 'CMD-TRACE-015-FUNCTIONAL-RESUME-REGISTRY-TEST',
    command:
