...
### 2.1 缺少 `currentMentalModel` 的真实读写闭环
...
### 2.3 缺少统一 `controlled-blocker-intake`
...
### 2.5 Architecture Confirmation 没有完全接入 main-agent action switch
...
### 2.7 Execution Closure 与 closeout 之间缺少模型级汇总
...
### 2.8 Dashboard 的 6 模型只是 read model
...
## 5. controlled-blocker-intake 详细机制
...
## 6. main-agent-mental-model-gate
...
## 7. controlled-reconfirmation-router
...
## 8. Architecture Confirmation 接入主控
...
## 20. Must Not Count As Completion
