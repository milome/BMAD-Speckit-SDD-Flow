...
- [`runtime-dashboard.md`](./runtime-dashboard.md) — 启动 live dashboard、runtime MCP，以及查看 `/api/snapshot` / `resolvedRuntimeContext` / `sft_summary`；历史 `runtime_context` 只作 legacy projection
