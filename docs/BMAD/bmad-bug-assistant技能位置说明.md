...
- **bmad-bug-assistant**：**Cursor 全局技能**  
  `C:\Users\milom\.cursor\skills\bmad-bug-assistant\SKILL.md`  
  所有改进（禁止词表、审计模板、首句角色定位等）都写在这个文件里。

- **bmad-story-assistant**：**Cursor 全局技能**  
  `C:\Users\milom\.cursor\skills\bmad-story-assistant\SKILL.md`

- **bmad-customization-backup**：**Cursor 全局技能**  
  `C:\Users\milom\.cursor\skills\bmad-customization-backup\SKILL.md`（含 scripts、references 子目录）
...
- **保留**：`C:\Users\milom\.cursor\skills\bmad-bug-assistant\SKILL.md`（全局）。
...
1. 在 Cursor 设置/技能列表中查看两条分别对应的路径，确认是否都指向 `C:\Users\milom\.cursor\skills\bmad-bug-assistant\`。
