...
| Real PR topology closure | `scripts/main-agent-host-matrix-pr-orchestrator.ts`, `scripts/parallel-mission-control.ts` | `tests/acceptance/main-agent-host-matrix-pr-orchestration.test.ts`, `_bmad-output/runtime/pr/pr_topology.json` |
