...
const ACTIONS = [
  'initialize-six-model-requirement-confirmation',
  'reconfirmation-runtime',
  'requirement-record-control-store',
  'requirement-record-live-schema-gate',
  'requirement-record-schema-evolution',
  'resolve-active-requirement',
  'runtime-scoring-data-path',
  'six-model-runtime-decision',
];
...
function makeConsumerRoot() {
  return fs.mkdtempSync(path.join(os.tmpdir(), 'main-agent-wave-3-7-'));
}
...
describe('main-agent wave 3.7 package runtime actions', () => {
  ...
  it('supports wave 3.7 actions from package source runtime with stable envelopes', async () => {
