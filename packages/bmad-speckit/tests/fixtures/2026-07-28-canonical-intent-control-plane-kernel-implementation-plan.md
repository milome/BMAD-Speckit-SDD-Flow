# Test Fixture: Canonical Intent Control Plane Kernel
...
#### Files
- Inspect: `packages/fixture/kernel/`
#### Verification Steps
- Run all task-specific commands against the same source tree.
#### Acceptance Criteria
...
## Normative Composite Authority Fixture
...
sourceCompositionPolicy:
  ...
  requiredSubordinateBindings:
    - role: subordinate_component_specification
      ...
      parentTaskRefs: [J04]
      requiredRequirementIds: [BCR-C01, BCR-C02, BCR-C03, BCR-C04, BCR-C05, BCR-C06]
      requiredTaskIds: [BCR-T01, BCR-T02, BCR-T03, BCR-T04, BCR-T05, BCR-T06, BCR-T07, BCR-T08]
