...
exports.generateEvalRunId = generateEvalRunId;
exports.validateQuestionVersionForEval = validateQuestionVersionForEval;
/**
 ...
 */
function generateEvalRunId(questionId, version, timestamp) {
 ...
 */
function validateQuestionVersionForEval(scenario, questionVersion) {
    if (scenario !== 'eval_question')
        return;
