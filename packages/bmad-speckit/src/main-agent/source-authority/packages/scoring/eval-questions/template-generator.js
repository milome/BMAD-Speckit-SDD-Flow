...
exports.generateNextQuestionId = generateNextQuestionId;
exports.generateQuestionTemplate = generateQuestionTemplate;
exports.addQuestionToManifest = addQuestionToManifest;
/**
 ...
 */
function generateNextQuestionId(questions) {
    let max = 0;
 ...
 */
function generateQuestionTemplate(params) {
 ...
 * @returns {void}
 */
function addQuestionToManifest(versionDir, entry) {
