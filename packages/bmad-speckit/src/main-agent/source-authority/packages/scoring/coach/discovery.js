...
exports.discoverLatestRunId = discoverLatestRunId;
/**
...
function parseRecords(content, _filePath) {
    const records = [];
    try {
 ...
 */
function discoverLatestRunId(dataPath, limit = DEFAULT_LIMIT, scenarioFilter) {
