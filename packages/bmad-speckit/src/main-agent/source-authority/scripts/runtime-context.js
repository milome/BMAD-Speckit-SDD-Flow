...
exports.mergeLanguagePolicyIntoProjectContext = mergeLanguagePolicyIntoProjectContext;
...
const reviewer_runtime_definition_1 = require("./reviewer-runtime-definition");
...
function mergeLanguagePolicyIntoProjectContext(root, languagePolicy) {
    ...
    (0, facilitator_runtime_definition_1.ensureFacilitatorRuntimeDefinition)(root);
    (0, reviewer_runtime_definition_1.ensureReviewerRuntimeDefinition)(root);
    return {
        status: 'updated',
        contextPath: file,
    };
...
function readRegistryOrDefault(root) {
    try {
        return (0, runtime_context_registry_1.readRuntimeContextRegistry)(root);
    }
    catch {
        return (0, runtime_context_registry_1.defaultRuntimeContextRegistry)(root);
    }
}
...
function ensureProjectRuntimeContext(root, options) {
    ...
    const registry = detectedSourceMode === 'full_bmad' && fs.existsSync(sprintStatusPath)
        ? (0, runtime_context_registry_1.buildProjectRegistryFromSprintStatus)(root, sprintStatusPath)
        : (0, runtime_context_registry_1.defaultRuntimeContextRegistry)(root);
    registry.activeScope = {
        scopeType: 'project',
        resolvedContextPath: registry.projectContextPath,
        reason: 'ensureProjectRuntimeContext bootstrap',
    };
    (0, runtime_context_registry_1.writeRuntimeContextRegistry)(root, registry);
    return payload;
}
