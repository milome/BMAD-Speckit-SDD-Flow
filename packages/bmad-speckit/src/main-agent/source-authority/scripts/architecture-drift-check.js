...
exports.runArchitectureDriftCheck = runArchitectureDriftCheck;
exports.main = main;
...
function runArchitectureDriftCheck(root) {
    ...
    const failures = REQUIRED_INVARIANTS.flatMap((invariant) => invariant.terms
