...
const TARGET_PATHS = [
  ...
  'packages/bmad-speckit/src/main-agent/source-authority/scripts/parallel-mission-control.ts',
  ...
  'packages/bmad-speckit/src/main-agent/source-authority/scripts/e2e-dual-host-journey-runner.ts',
  'packages/bmad-speckit/src/main-agent/source-authority/scripts/party-mode-runtime.ts',
  'packages/bmad-speckit/src/main-agent/source-authority/scripts/facilitator-runtime-definition.ts',
  'packages/bmad-speckit/src/main-agent/source-authority/scripts/i18n/materialize-facilitator-definition.ts',
  'packages/bmad-speckit/src/main-agent/source-authority/scripts/i18n/sync-party-mode-mirrors.ts',
  'packages/bmad-speckit/src/constants/ai-registry-builtin.ts',
  'packages/bmad-speckit/src/services/sync-service.ts',
  'packages/bmad-speckit/src/services/ai-registry.ts',
  'packages/bmad-speckit/src/commands/init.ts',
