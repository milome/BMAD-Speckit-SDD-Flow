...
exports.readBmadProgress = readBmadProgress;
exports.readStoryState = readStoryState;
exports.getCurrentStoryState = getCurrentStoryState;
exports.buildPaths = buildPaths;
const fs = __importStar(require("fs"));
const yaml = __importStar(require("js-yaml"));
const path = __importStar(require("path"));
function readBmadProgress() {
...
function readStoryState(epic, story) {
