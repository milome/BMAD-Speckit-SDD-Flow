...
OPTIONAL_SKILLS=(bmad-standalone-tasks bmad-customization-backup bmad-orchestrator npm-public-release using-git-worktrees pr-template-generator auto-commit-utf8 git-push-monitor requirements-contract-authoring requirements-contract-grill req-trace-matrix-prompt-generator)
