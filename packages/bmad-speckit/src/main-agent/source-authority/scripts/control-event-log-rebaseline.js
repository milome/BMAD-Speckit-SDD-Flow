...
exports.mainControlEventLogRebaseline = mainControlEventLogRebaseline;
...
function detectedBreaks(events) {
    const breaks = [];
...
function mainControlEventLogRebaseline(argv) {
    ...
    const eventLogPath = (0, requirement_record_control_store_1.eventLogPathForRecord)(recordPath);
    ...
    const payload = {
        rebaseline: {
            ...
            priorRecordHash: (0, requirement_record_control_store_1.sha256Json)(record),
