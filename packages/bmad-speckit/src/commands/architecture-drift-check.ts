async function architectureDriftCheckCommand(opts = {}, forwardedArgv = []) {
  ...
  else process.stdout.write("architecture-drift-check" + ': package CLI surface ready\n');
  return 0;
}
