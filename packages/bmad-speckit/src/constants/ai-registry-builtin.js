 ...
 */
module.exports = [
  { id: 'cursor-agent', name: 'Cursor Agent', description: 'Cursor IDE built-in agent', configTemplate: { commandsDir: '.cursor/commands', rulesDir: '.cursor/rules', skillsDir: '.cursor/skills', skillScope: 'project', agentsDir: '.cursor/agents', subagentSupport: 'native', sourceDir: 'cursor', platformSkillsDir: '_bmad/cursor/skills', rulesFormat: 'mdc' } },
  { id: 'claude', name: 'Claude', description: 'Anthropic Claude (Claude Code, Claude Desktop)', configTemplate: { commandsDir: '.claude/commands', rulesDir: '.claude/rules', skillsDir: '.claude/skills', skillScope: 'project', agentsDir: '.claude/agents', subagentSupport: 'native', sourceDir: 'claude', platformSkillsDir: '_bmad/claude/skills', hooksDir: '.claude/hooks', protocolsDir: '.claude/protocols', rulesFormat: 'md' } },
  ...
  { id: 'codex', name: 'Codex', description: 'Codex CLI', configTemplate: { commandsDir: '.codex/commands', skillsDir: '.codex/skills', skillScope: 'project', agentsDir: '.codex/agents', platformSkillsDir: '_bmad/codex/skills', protocolsDir: '.codex/protocols', i18nDir: '.codex/i18n', readmePath: '.codex/README.md', subagentSupport: 'native', sourceDir: 'codex' } },
