...
- IF P: Read fully and follow: {partyModeWorkflow} using the `brief-gate` stage profile with current blocker/gap context to bring different perspectives to validate user understanding and resolve blocker gaps
