...
| 文件 | 用途 | 控制策略 |
|------|------|----------|
| `.cursor/skills/bmad-story-assistant/SKILL.md` | 五层架构概览 | 提取「五层架构概览」段落（约 20 行） |
| `.cursor/skills/speckit-workflow/SKILL.md` | TDD、ralph-method、15 条铁律 | 提取关键段落或前 N 行 |
| `.cursor/skills/speckit-workflow/references/audit-prompts-critical-auditor-appendix.md` | 批判审计员格式 | 全文或必填结构段落 |
