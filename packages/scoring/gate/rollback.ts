 ...
 * @param {string} [lastStableCommit] - 最后一次稳定提交的哈希
 * @returns {RollbackSuggestion} 回退建议对象
 */
export function suggestRollback(stage: string, lastStableCommit?: string): RollbackSuggestion {
