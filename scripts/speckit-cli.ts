...
const COMMANDS: Record<string, CommandConfig> = {
  ...
  specify: {
    ...
    agentFile: '.claude/agents/layers/bmad-layer4-speckit-specify.md',
    stage: 'spec',
  ...
  plan: {
    ...
    optionalArgs: ['epicSlug', 'storySlug', 'mode', 'constitutionPath'],
    agentFile: '.claude/agents/layers/bmad-layer4-speckit-plan.md',
    stage: 'plan',
  ...
  gaps: {
    ...
    agentFile: '.claude/agents/gaps.md',
    stage: 'plan',
  ...
  tasks: {
    ...
    agentFile: '.claude/agents/layers/bmad-layer4-speckit-tasks.md',
    stage: 'tasks',
