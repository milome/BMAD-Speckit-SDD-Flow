...
export function runDualHostJourneyRunner(argv: string[]): number {
...
if (require.main === module) {
  process.exit(runDualHostJourneyRunner(process.argv.slice(2)));
}
