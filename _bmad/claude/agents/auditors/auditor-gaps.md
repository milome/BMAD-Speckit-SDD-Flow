...
3. 将 `projectRoot`、`reportPath`、`artifactDocPath`、`stage=gaps` 返回给 invoking host/runner，由 host/runner 统一通过 `runAuditorHost` 承接评分写入、auditIndex 更新与其它 post-audit automation
